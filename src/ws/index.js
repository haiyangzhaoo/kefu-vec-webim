...
function _handleMessage(msg, options){
	...
	var microphone = utils.getDataByPath(msg, 'ext.msgtype.microphone')
	var camera = utils.getDataByPath(msg, 'ext.msgtype.camera')
	...
	case 'rtcSessionInfo':
		...
		break;
	case 'microphone':
		event.emit(SYSTEM_OPERA_MICROPHONE, microphone)
		break;
	case 'camera':
		event.emit(SYSTEM_OPERA_CAMERA, camera)
		break;
	default:
